...
export default defineComponent({
  ...
  setup() {
    const table = [
      {
        img: getAssetPath("public/public/media/stock/600x600/img-49.jpg"),
        title: "Mivy App",
        name: "Jane Cooper",
        price: "32,400",
        statistics: "9.2",
      ...
      {
        img: getAssetPath("public/media/stock/600x600/img-40.jpg"),
        title: "Avionica",
        name: "Esther Howard",
        price: "256,910",
        statistics: "0.4",
      ...
      {
        img: getAssetPath("public/media/stock/600x600/img-39.jpg"),
        title: "Charto CRM",
        name: "Jenny Wilson",
        price: "8,220",
        statistics: "9.2",
      ...
      {
        img: getAssetPath("public/media/stock/600x600/img-47.jpg"),
        title: "Tower Hill",
        name: "Cody Fisher",
        price: "74,000",
        statistics: "9.2",
      ...
      {
        img: getAssetPath("public/media/stock/600x600/img-48.jpg"),
        title: "9 Degree",
