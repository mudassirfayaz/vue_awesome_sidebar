...
const routes: Array<RouteRecordRaw> = [
  {
    ...
    beforeEnter: (to, from, next) => {
      ...
      const isAuthenticated = JwtService.getToken(); // Implement your own authentication check
    ...
    children: [
      ...
      },
      {
        path: "/providers",
        name: "providers",
        component: () => import("@/components/Pages/Provider/Providers.vue"),
        meta: {
          pageTitle: "Providers",
      ...
      },
      {
        ...
        name: "provider",
        component: () =>
          import("@/components/Pages/Provider/ProviderDetails.vue"),
        meta: {
          pageTitle: "Provider Details",
          breadcrumbs: ["Provider Details"],
        },
      },
      {
        path: "/clients",
      ...
      },
      {
        ...
        name: "Client Details",
        component: () => import("@/components/Pages/Clients/ClientDetails.vue"),
        meta: {
          pageTitle: "Client Details",
          breadcrumbs: ["ClientDetails"],
        },
      },
      {
        path: "/compliance",
        name: "Compliance Listing",
        component: () =>
          import("../components/Pages/Compliances/Compliance.vue"),
        meta: {
      ...
      },
      {
        path: "/property",
        name: "Property",
        component: () => import("../components/Pages/Property/Property.vue"),
        meta: {
          pageTitle: "Property",
      ...
      },
      {
        path: "/rooms",
        name: "Rooms",
        component: () => import("../components/Pages/Property/Rooms/Rooms.vue"),
        meta: {
          pageTitle: "Property",
          breadcrumbs: ["Properties", "Rooms"],
        },
      },
      {
        path: "/room-details",
        name: "Add Room",
        component: () =>
          import("../components/Pages/Property/Rooms/AddRoom.vue"),
        meta: {
          pageTitle: "Add Room",
          breadcrumbs: ["Property", "Rooms", "Add Room"],
        },
      },
      {
        path: "/users",
